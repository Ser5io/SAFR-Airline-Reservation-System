...
class Location_To(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        heading = customtkinter.CTkLabel(self,
                                        text="The Location You Travel To",
                                        fg_color="white",
                                        text_color="black",
        ...
        master.Ulocationto = combobox_var
        
        combo_box.set("Choose an option")  # Set the default value
        combo_box.place(x=450, y=410)
        ...
        button6 = customtkinter.CTkButton(self,
                                        ...
                                        hover_color="#0065B4",
                                        command=master.go_to_flighttype)
